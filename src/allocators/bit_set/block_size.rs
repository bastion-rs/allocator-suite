...
impl BlockSize
{
	...
	#[inline(always)]
	pub(crate) fn alignment_is_minimum(&self, non_zero_power_of_two_alignment: NonZeroUsize) -> bool
	{
	...
	#[inline(always)]
	pub(crate) fn blocks_offset(&self, allocations_start_from: MemoryAddress, start_of_allocated_memory: MemoryAddress) -> NumberOfBits
	{
