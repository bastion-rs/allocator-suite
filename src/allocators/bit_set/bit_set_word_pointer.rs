...
impl BitSetWordPointer
{
	...
	#[inline(always)]
	pub(crate) fn unset_middle_bits(self, number_of_bits_to_unset: NumberOfBits, number_of_lower_bits: NumberOfBits)
	{
	...
	#[inline(always)]
	pub(crate) fn increment_in_bit_set_words(self, number_of_bit_set_words: NumberOfBitSetWords) -> Self
	{
	...
	#[inline(always)]
	pub(crate) fn decrement_in_bit_set_words(self, number_of_bit_set_words: NumberOfBitSetWords) -> Self
	{
